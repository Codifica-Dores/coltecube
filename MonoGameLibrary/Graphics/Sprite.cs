...
public class Sprite
{
    ...
    /// <summary>
    /// Clone this sprite, creating a new instance with the same properties.
    /// </summary>
    /// <returns>A new Sprite instance that is a clone of this sprite.</returns>
    public Sprite Clone()
    {
        var novo = new Sprite(this.Region);
        novo.Color = this.Color;
        novo.Rotation = this.Rotation;
        novo.Scale = this.Scale;
        novo.Origin = this.Origin;
        novo.Effects = this.Effects;
        novo.LayerDepth = this.LayerDepth;
        return novo;
    }
}
